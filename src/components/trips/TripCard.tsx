...
export default function TripCard({ trip }: TripCardProps) {
  ...
  return (
    <Link href={`/trips/${trip.id}`}>
      <article className="bg-sand rounded-3xl border border-sand-dark hover:border-rust/40 hover:shadow-md transition-all active:scale-[0.99] cursor-pointer overflow-hidden">
        {/* Coloured top accent */}
        ...
        <div className="p-5">
          ...
          <div className="flex items-start justify-between gap-3 mb-3">
            ...
            <span
              className={cn(
                "inline-flex text-xs font-body font-semibold px-2.5 py-1 rounded-full flex-shrink-0",
                badge.bg,
                badge.text
              )}
            >
